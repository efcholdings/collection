...
const ArtworkSchema = z.object({
    ...
    imagePath3: z.string().optional().nullable(),
    imagePath4: z.string().optional().nullable(),
    imagePath5: z.string().optional().nullable(),
...
export async function updateArtwork(id: string, formData: FormData) {
    ...
    const data = {
        ...
        imagePath2: formData.get('imagePath2') as string | null,
        imagePath3: formData.get('imagePath3') as string | null,
        imagePath4: formData.get('imagePath4') as string | null,
        imagePath5: formData.get('imagePath5') as string | null,
